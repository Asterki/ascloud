		...
		try {
			const parsedBody = z
				.object({
					...
					password: z
						.string()
						.min(6, { message: "password-size" })
						.max(256, { message: "password-size" }),
				})
				.required()
				.safeParse({
					email: email,
					...
					message:
						lang.modal.errors[
							parsedBody.error.errors[0]
								.message as keyof typeof lang.modal.errors
						],
				});
				...
				>
					...
					<div className={styles["activate-tfa-input"]}>
						<input
							type="checkbox"
							id="activate-tfa"
							ref={activateTFAInput}
						/>
						<label htmlFor="activate-tfa">
							{lang.form.activateTFA}
						</label>
					</div>
					<br />
					<br />
