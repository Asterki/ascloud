...
router.post(
	"/register",
	async (
		req: express.Request<unknown, RouteTypes.RegisterResponse, RouteTypes.RegisterRequestBody>,
		res: express.Response<RouteTypes.RegisterResponse>
	) => {
		try {
			// Validate fields
			const parsedBody = z
...
router.post(
	"/delete-account",
	async (
		req: express.Request<unknown, RouteTypes.DeleteAccountResponse, RouteTypes.DeleteAccountRequestBody>,
		res: express.Response<RouteTypes.DeleteAccountResponse>
	) => {
...
router.post(
	"/login",
	(
		req: express.Request<unknown, RouteTypes.LoginResponse, RouteTypes.LoginRequestBody>,
		res: express.Response<RouteTypes.LoginResponse>,
		next
	) => {
		try {
			const parsedBody = z
...
router.post(
	"/logout",
	(
		req: express.Request<unknown, RouteTypes.LogoutResponse, unknown>,
		res: express.Response<RouteTypes.LogoutResponse>
	) => {
		try {
